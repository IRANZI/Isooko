...
type NavigationProp = NativeStackNavigationProp<RootStackParamList, 'WaterQualityScreen'>;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topSection}>
        <Image
          source={require('../assets/images/waterQuality.png')}
      ...
      <View style={styles.bottomSection}>
        <Text style={styles.title}>Track Your Water Quality & Level</Text>
        <Text style={styles.subtitle}>
          Set the reminders and keep in track with your water usage daily.
        </Text>
        ...
        <View style={styles.buttonRow}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.replace('AchievementScreen')}
          >
